...
public class progressive_model {
    ...
    String finished,started,id, Address, clue, discount, group_type, lat, longi, name, post_type, runningCount, sponsor_logo, sponsor_name, status, successCount, time_limit;
