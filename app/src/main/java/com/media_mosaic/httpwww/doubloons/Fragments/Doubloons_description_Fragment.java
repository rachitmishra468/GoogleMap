...
public class Doubloons_description_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view= inflater.inflate(R.layout.fragment_doubloons_description_, container, false);
        ...
        description_text_view.setText(getArguments().getString("description"));
        pDialog = new ProgressDialog(getActivity());
        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();
        if(readPref.getusertype().equals("player")){
            url=  "http://www.doubloon.media-mosaic.in/apis/getPlayerAdvertise";
        }
        else {
            url=  "http://www.doubloon.media-mosaic.in/apis/getPartnerAdvertise";
        }
        GetResponse();
