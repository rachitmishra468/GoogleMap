...
public class MyAvailableDoubloonsFragment extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_my_available_doubloons, container, false);
        ...
        groceryAPICALL.sendData(Request.Method.POST, "http://www.doubloon.media-mosaic.in/apis/getMyAvailableDoubloons", params, "item");
