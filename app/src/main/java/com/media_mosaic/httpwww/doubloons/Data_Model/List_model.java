...
/**
 * Created by akash on 2/22/2018.
 */

public class List_model{

    String id, Address, clue, discount, group_type, lat, longi, name, post_type, runningCount, sponsor_logo, sponsor_name, status, successCount, time_limit;
